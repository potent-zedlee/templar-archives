...
var init_esm_min = __esm({
  "node_modules/formdata-polyfill/esm.min.js"() {
    ...
    e = /* @__PURE__ */ __name((c, f2) => (f2 ? c : c.replace(/\r?\n|\r/g, "\r\n")).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), "e");
...
var init_from = __esm({
  "node_modules/fetch-blob/from.js"() {
    ...
    init_fetch_blob();
    ({ stat } = fs);
    blobFromSync = /* @__PURE__ */ __name((path, type) => fromBlob(statSync(path), path, type), "blobFromSync");
    ...
    fileFromSync = /* @__PURE__ */ __name((path, type) => fromFile(statSync(path), path, type), "fileFromSync");
    ...
    fromFile = /* @__PURE__ */ __name((stat2, path, type = "") => new file_default([new BlobDataItem({
      ...
      lastModified: stat2.mtimeMs,
      start: 0
    })], basename(path), { type, lastModified: stat2.mtimeMs }), "fromFile");
...
*/
//# sourceMappingURL=chunk-WA3XETO4.mjs.map
