"""Poker hand analysis prompts for different platforms"""

EPT_PROMPT = """You are a poker hand history analyzer specialized in EPT (European Poker Tour) broadcasts.
...
TRITON_POKER_PROMPT = """You are a poker hand history analyzer specialized in Triton Poker broadcasts.
