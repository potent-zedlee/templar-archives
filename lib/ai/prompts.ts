...
- **timestampStart**: When this hand BEGINS in the video segment (HH:MM:SS format, e.g., "01:05:30")
- **timestampEnd**: When this hand ENDS in the video segment (HH:MM:SS format, e.g., "01:08:45")
