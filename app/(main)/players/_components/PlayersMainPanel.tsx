    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      ...
      <ScrollArea className="flex-1">
        <div className="p-4 md:p-6">
          <StaggerContainer key={`${currentPage}-${filteredPlayers.length}`} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6" staggerDelay={0.05}>
